...
ipdb.export_vivado(script_path="fpga/arty_pulpino/tcl/ips_src_files.tcl", alternatives=['riscv'])
# generate Vivado add_files.tcl
ipdb.generate_vivado_add_files("fpga/arty_pulpino/tcl/ips_add_files.tcl", alternatives=['riscv'])
# generate Vivado inc_dirs.tcl
ipdb.generate_vivado_inc_dirs("fpga/arty_pulpino/tcl/ips_inc_dirs.tcl", alternatives=['riscv'])
